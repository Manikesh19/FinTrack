...
const TransactionTable = ({ transactions }) => {
    ...
    const handleBulkDelete = async () => {
        if(!window.confirm(`Are you sure want to delete ${selectedIds.length} transactions?`)) {
            return;
        }
            ...
            <div className="flex flex-col sm:flex-row gap-4">
                ...
                <div className="flex gap-2">
                    ...
                    {(searchTerm || typeFilter || recurringFilter) && (
                        <Button variant="destructive" size="icon" onClick={handleClearFilters} title="Clear Filters">
                            <X className="w-5 h-4"/>
                        </Button>
                    )}
                </div>
                                ...
                                <TableRow key={transaction.id}>
                                    ...
                                    <TableCell>
                                        {transaction.isRecurring? (
                                            <Tooltip>
                                                <TooltipTrigger>
                                                    <Badge variant="outline" className="gap-1 rounded bg-purple-100 text-purple-700 hover:bg-purple-200">
